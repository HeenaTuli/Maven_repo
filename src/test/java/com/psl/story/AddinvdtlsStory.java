...
import com.psl.steps.AddInvDtlsSteps;

public class AddinvdtlsStory extends JUnitStory {
	
	public AddinvdtlsStory() {
	...
	public Configuration configuration() {
		...
		return new MostUsefulConfiguration().useStoryLoader(
				...
				new StoryReporterBuilder().withFormats(Format.HTML, Format.CONSOLE, Format.TXT, Format.STATS));
	}
	
	@Override
	public List<CandidateSteps> candidateSteps() {
		return new InstanceStepsFactory(configuration(), new AddInvDtlsSteps())
